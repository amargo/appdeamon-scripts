...
class Eon(hass.Hass):
    ...
    def get_chart_data(self, profile_data_url, session, eon_1_8_0_report, eon_2_8_0_report):
        ...
        for positive_a in jsonResponse[0]['data']:
            ...
            eon_1_8_0_report_time, eon_1_8_0_report_value = get_value_from_datetime_dict(eon_1_8_0_report, eon_positive_a_time)
        ...
        for negative_a in jsonResponse[1]['data']:
            ...
            eon_2_8_0_report_time, eon_2_8_0_report_value = get_value_from_datetime_dict(eon_2_8_0_report, eon_negative_a_time)
    ...
    def normalize_eon_report_data(self, eon_type, data, numeric_precision):
        self.log("normalize_eon_report_data - %s, %s", eon_type, data)
        try:
            for eon_value, eon_time in data.items():
                extra_parameter = " AND state = " + str(eon_value)
            ...
            print(datetime.datetime.now(), "Error normalize_eon_report_data {0}.".format(str(ex)))
        finally:
            print("END - normalize_eon_report_data")
